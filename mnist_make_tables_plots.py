...
paths = filter(
    ...
    itertools.chain(
        walklevel(
            "logs/image/MNIST/GP-RBF/mnist_experiments_more_chol/batch_size=300,model.chol_noise=1e-06,model.kernel_length_scale=1.0,model.kernel_sigma_var=0.05",
            level=1,
        ),
        walklevel(
            "logs/image/MNIST/CNP/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/T2-huge/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/C4-regular_huge/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/C8-regular_huge/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/C16-regular_huge/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/D4-regular_huge/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/D8-regular_huge/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/SO2-irrep_huge/mnist_experiments",
            level=2,
        ),
        walklevel(
            "logs/image/MultiMNIST/T2-huge/mnist_experiments_finetune",
            level=2,
        ),
        walklevel(
            "logs/image/MultiMNIST/C4-regular_huge/mnist_experiments_finetune",
            level=2,
        ),
        walklevel(
            "logs/image/MultiMNIST/C8-regular_huge/mnist_experiments_finetune",
            level=2,
        ),
        walklevel(
            "logs/image/MultiMNIST/C16-regular_huge/mnist_experiments_finetune",
            level=2,
        ),
        walklevel(
            "logs/image/MultiMNIST/D4-regular_huge/mnist_experiments_finetune",
            level=2,
        ),
        walklevel(
            "logs/image/MultiMNIST/D8-regular_huge/mnist_experiments_finetune",
            level=2,
        ),
        walklevel(
            "logs/image/MultiMNIST/SO2-irrep_huge/mnist_experiments_finetune",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/T2-huge/mnist_experiments_blanks",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/C4-regular_huge/mnist_experiments_blanks",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/C8-regular_huge/mnist_experiments_blanks",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/C16-regular_huge/mnist_experiments_blanks",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/D4-regular_huge/mnist_experiments_blanks",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/D8-regular_huge/mnist_experiments_blanks",
            level=2,
        ),
        walklevel(
            "logs/image/MNIST/CNP/mnist_experiments_blanks",
            level=2,
        ),
        # walklevel(
        #     "logs/image/MNIST/SO2-irrep_huge/mnist_experiments_blanks",
        #     level=2,
        # ),
    ),
)
...
paths = filter(
    ...
    itertools.chain(
        walklevel(
            "logs/image/MNIST/GP-RBF/mnist_experiments_more_chol/",
            level=2,
        ),
    ),
)
