...
ax.set_aspect("equal")
ax.axis("off")
plt.savefig("plots/curlfree.pdf", bbox_inches="tight")
# %%
dataset = div
...
ax.set_aspect("equal")
ax.axis("off")
plt.savefig("plots/divfree.pdf", bbox_inches="tight")
...
ax.set_aspect("equal")
ax.axis("off")
plt.savefig("plots/rbf.pdf", bbox_inches="tight")
...
plt.savefig(
    "plots/combined_gp_datasets.pdf",
    bbox_inches="tight",
)
